		...
		<Card>
			...
			<CardContent className="space-y-4">
				...
				<Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
					<DialogContent className="max-sm:top-0 max-sm:left-0 max-sm:translate-x-0 max-sm:translate-y-0 max-sm:h-full max-sm:max-w-none max-sm:rounded-none max-sm:border-0 sm:max-w-lg overflow-y-auto">
						<DialogHeader>
						...
						<DialogFooter className="max-sm:mt-auto max-sm:pb-safe">
